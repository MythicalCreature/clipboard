---
date: 2026-05-23T02:24:20+08:00
source: clipboard
chars: 1297
---

FO:     Uvicorn running on http://0.0.0.0:4000 (Press CTRL+C to quit)
INFO:     127.0.0.1:52054 - "HEAD / HTTP/1.1" 200 OK
02:24:03 - LiteLLM Proxy:ERROR: endpoints.py:121 - litellm.proxy.proxy_server.anthropic_response(): Exception occured - 400: {'error': 'anthropic_messages: Invalid model name passed in model=claude-opus-4-7. Call `/v1/models` to view available models for your key.'}
...
INFO:     127.0.0.1:52065 - "POST /v1/messages?beta=true HTTP/1.1" 400 Bad Request
